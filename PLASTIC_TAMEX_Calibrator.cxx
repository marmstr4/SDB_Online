...
void PLASTIC_TAMEX_Calibrator::load_Calibration_Files(){
    ...
    ifstream map_file("Configuration_Files/MAP.dat");
   ...
   // int ch_num[100][100];
    ...
    for(int i = 0;i < iter;++i){
        ...
        sprintf(filename,"Configuration_Files/calibration/Calib_%d_%d.dat",tamex_id,ch_id);
        file.open(filename);
...
void PLASTIC_TAMEX_Calibrator::ONLINE_CALIBRATION(){
    ...
    ofstream map_file("Configuration_Files/MAP.dat");
    ...
    for(int i = 0;i < 100;++i){
        for(int j = 0;j < 100;++j){
            ...
            if(fired[i][j]){
                ...
                sprintf(filename,"Configuration_Files/calibration/Calib_%d_%d.dat",i,j);
